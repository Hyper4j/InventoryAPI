package com.hyperstudio.InventoryAPI.v1_16_5;
...
public class ItemAPI_v1_16_5 {
	
	public static String checkItem(Player player) {
		ItemStack item = player.getItemInHand();
		
		net.minecraft.server.v1_16_R3.ItemStack items = CraftItemStack.asNMSCopy(item);
	...
	public static ItemStack parseItem(String metadata) {
		...
		try {
			itemStack = net.minecraft.server.v1_16_R3.ItemStack.a(MojangsonParser.parse(metadata));

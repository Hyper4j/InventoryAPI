package com.hyperstudio.InventoryAPI.v1_14_4;
...
public class ItemAPI_v1_14_4 {
	
	public static String checkItem(Player player) {
		ItemStack item = player.getItemInHand();
		
		net.minecraft.server.v1_14_R1.ItemStack items = CraftItemStack.asNMSCopy(item);
	...
	public static ItemStack parseItem(String metadata) {
		...
		try {
			itemStack = net.minecraft.server.v1_14_R1.ItemStack.a(MojangsonParser.parse(metadata));
